...
> Última actualización: julio 2026 (chiloe.html agregado).
...
- **Páginas (13):**
  ...
  8. `en/torres-del-paine.html` (inglés)
  9. `en/san-pedro-de-atacama.html` (inglés)
  10. `en/puerto-varas.html` (inglés)
  11. `en/frutillar.html` (inglés)
  12. `en/saltos-del-petrohue.html` (inglés)
